...
ARGS=$(getopt  -o  i:I:t:n:h --long input_forward:,input_reverse:,thread:,sample_name:,help -- "$@")
...
fastqc --threads $thread  -o ../origin_fastqc $input_forward $input_reverse

fastp --detect_adapter_for_pe \
        --overrepresentation_analysis \
        --correction --cut_right --thread $thread \
        --html ../trimmed/anc.fastp.html --json ../trimmed/anc.fastp.json \
        -i $input_forward -I $input_reverse \
        -o ../trimmed/${sample_name}_trimed_R1.fastq.gz -O ../trimmed/${sample_name}_trimed_R2.fastq.gz 


fastqc --threads $thread  -o ../trimmed_fastqc  ../trimmed/${sample_name}_trimed_R1.fastq.gz  ../trimmed/${sample_name}_trimed_R2.fastq.gz 
